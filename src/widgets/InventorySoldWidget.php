 ...
 * @since     1.0.0
 */
class InventorySoldWidget extends Widget
{
    ...
    {
        return Craft::t('commerce-reports', 'Commerce Reports - Inventory Sold');
    }
    ...
    public function rules()
    {
        ...
        $rules = array_merge(
            ...
            [
                ['reportType', 'string'],
                ['reportType', 'default', 'value' => 'inventory-sold']
            ]
        );
        return $rules;
    }
